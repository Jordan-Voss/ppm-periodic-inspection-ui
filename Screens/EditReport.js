...
export default class EditReport extends React.Component {
  ...
  handleSaveReport = async () => {
    ...
    console.log(prNumber,
      ...
      isFullExtent,
      earthingType);
    const respon = await updateReport(reportName, prNumber,
      contractorName, contractorAddress,
      contractorRegNumber,
      installationAge,
      occupantName,
  ...
  render() {
    ...
    const inspectionReasonCommentTextInput = (
      <View>
      <TextInput style={styles.TextInput} onChangeText={this.onInspectionReasonCommentChange} placeholder={this.state.inspectionReasonComment}></TextInput>
      </View>
    );
